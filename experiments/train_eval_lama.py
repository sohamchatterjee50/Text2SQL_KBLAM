...
parser.add_argument("--train_dataset",type=str,default="random_dev_bird_naive_90",choices=["train_dev_bird_naive_100", "random_dev_bird_naive_90"])
...
parser.add_argument("--hf_model_spec", type=str, default="microsoft/phi-4", choices=["microsoft/phi-4","microsoft/Phi-4-mini-instruct","meta-llama/Meta-Llama-3-8B", "microsoft/Phi-3-mini-4k-instruct", "meta-llama/Llama-3.2-1B-Instruct"])
